  ...
  create view "retail_analytics"."dbt_staging"."stg_order_payments__dbt_tmp"
    
    
  as (
    with source_order_payments as (select * from "retail_analytics"."raw"."olist_order_payments"),
